...
<div class="login-wrap">
    <div class="login-html">
        ...
        <div class="login-form">
            ...
            <form action="${pageContext.request.contextPath}/StudentValidationServlet" method="post">
                <div class="group">
            ...
            <div class="sign-up-htm">
                <form action="${pageContext.request.contextPath}/StudentRegistrationServlet" method="post">
                <div class="group">
